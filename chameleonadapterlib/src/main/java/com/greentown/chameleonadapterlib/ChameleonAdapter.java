...
public class ChameleonAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        BaseItemViewBinder<?, ?> binder = typeLinkPool.getItemViewBinder(viewType);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        BaseItemViewBinder itemViewPresenter = typeLinkPool.getItemViewBinder(holder.getItemViewType());
